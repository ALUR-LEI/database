...
REM loads test data (previously Waiheke Island dataset now (June 2020) and empty dataset).
REM
...
REM %zip_exe% e -y -p%archive_password% -o%data_path% %data_path%emptySOLAdabase.7z >> %BUILD_LOG% 2>&1
