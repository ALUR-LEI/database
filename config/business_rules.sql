...
resultado::::::::合并的记录不必出现在最终目标中。::::::::::::Records being consolidated must not be present in the destination. 
result', '', '');
INSERT INTO system.br (id, display_name, technical_type_code, feedback, description, technical_description) VALUES ('generate-notation-reference-nr', 'generate-notation-reference-nr', 'sql', '', NULL, '');
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('generate-notation-reference-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymmdd'') || ''-'' || trim(to_char(nextval(''administrative.rrr_nr_seq''), ''0000'')) AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('generate-rrr-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymmdd'') || ''-'' || trim(to_char(nextval(''administrative.rrr_nr_seq''), ''0000'')) AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('generate-source-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymmdd'') || ''-'' || trim(to_char(nextval(''source.source_la_nr_seq''), ''000000000'')) AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('generate-baunit-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymm'') || trim(to_char(nextval(''administrative.ba_unit_first_name_part_seq''), ''0000''))
|| ''/'' || trim(to_char(nextval(''administrative.ba_unit_last_name_part_seq''), ''0000'')) AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('generate-cadastre-object-lastpart', '2014-02-20', 'infinity', 'SELECT cadastre.get_new_cadastre_object_identifier_last_part(#{geom}, #{cadastre_object_type}) AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('generate-cadastre-object-firstpart', '2014-02-20', 'infinity', 'SELECT cadastre.get_new_cadastre_object_identifier_first_part(#{last_part}, #{cadastre_object_type}) AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('generate-spatial-unit-group-name', '2014-02-20', 'infinity', 'SELECT cadastre.generate_spatial_unit_group_name(get_geometry_with_srid(#{geom_v}), #{hierarchy_level_v}, #{label_v}) AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('generate-application-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || to_char(now(), ''yymm'') || trim(to_char(nextval(''application.application_nr_seq''), ''0000'')) AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-on-approve-check-public-display', '2014-02-20', 'infinity', '  SELECT (COUNT(*) = 0)  AS vl
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('app-check-title-ref', '2014-02-20', 'infinity', 'WITH 	convertTitleApp	AS	(SELECT se.id FROM application.service se
...
SELECT CASE 	WHEN (SELECT (COUNT(*) = 0) FROM convertTitleApp) THEN NULL
		...
		ELSE FALSE
	END AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-br7-check-sources-have-documents', '2014-02-20', 'infinity', 'SELECT ext_archive_id IS NOT NULL AS vl
FROM source.source 
WHERE id IN (SELECT source_id FROM application.application_uses_source WHERE application_id= #{id})');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('app-allowable-primary-right-for-new-title', '2014-02-20', 'infinity', 'WITH 	newTitleApp	AS	(SELECT (SUM(1) > 0) AS fhCheck FROM application.service se
				WHERE se.application_id = #{id}
 ...
 SELECT CASE WHEN (SELECT ((SELECT * FROM newTitleApp) OR (SELECT * FROM existTitleApp)) IS NULL) THEN NULL 
	...
	END AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('app-other-app-with-caveat', '2014-02-20', 'infinity', 'SELECT (SELECT COUNT(*) > 0 FROM application.service sv WHERE sv.application_id = ap.application_id AND sv.request_type_code IN (''varyCaveat'', ''removeCaveat'')) AS vl
...
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-cancel-property-service-before-new-title', '2014-02-20', 'infinity', '
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('app-title-has-primary-right', '2014-02-20', 'infinity', 'WITH 	newTitleApp	AS	(SELECT (SUM(1) > 0) AS fhCheck FROM application.service se
				WHERE se.application_id = #{id}
				AND se.request_type_code IN (''newFreehold'', ''newApartment'', ''newState'')),
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-br2-check-title-documents-not-old', '2014-02-20', 'infinity', 'SELECT s.recordation + 1 * interval ''1 week'' > NOW() AS vl
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('applicant-name-to-owner-name-check', '2014-02-20', 'infinity', 'WITH apStr AS (SELECT  COALESCE(name, '''') || '' '' || COALESCE(last_name, '''') AS searchStr FROM party.party pty
...
ORDER BY vl
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-br3-check-properties-are-not-historic', '2014-02-20', 'infinity', 'WITH baUnitRecs AS	(SELECT ba.status_code AS status FROM application.application_property ap
...
ORDER BY 1
LIMIT 1 ');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-br4-check-sources-date-not-in-the-future', '2014-02-20', 'infinity', 'SELECT ss.recordation < NOW() as vl FROM application.application_uses_source a_s
	INNER JOIN source.source ss ON (a_s.source_id = ss.id)
	WHERE a_s.application_id = #{id}
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-br6-check-new-title-service-is-needed', '2014-02-20', 'infinity', 'SELECT	CASE	WHEN (name_firstpart, name_lastpart) NOT IN (SELECT name_firstpart, name_lastpart FROM administrative.ba_unit)
...
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-on-approve-check-services-status', '2014-02-20', 'infinity', 'SELECT (COUNT(*) = 0)  AS vl FROM application.service sv 
WHERE sv.application_id = #{id} 
AND sv.status_code NOT IN (''completed'', ''cancelled'')');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-on-approve-check-services-without-transaction', '2014-02-20', 'infinity', 'SELECT (COUNT(*) = 0) AS vl FROM application.service sv 
	INNER JOIN transaction.transaction tn ON (sv.id = tn.from_service_id)
WHERE sv.application_id = #{id} 
AND sv.status_code NOT IN (''completed'', ''cancelled'')');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-on-approve-check-systematic-reg-no-objection', '2014-02-20', 'infinity', '  SELECT (COUNT(*) = 0)  AS vl
  ...
  and s.application_id = #{id};');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-br8-check-has-services', '2014-02-20', 'infinity', 'SELECT (COUNT(*) > 0) AS vl
FROM application.service sv 
WHERE sv.application_id = #{id}
AND sv.status_code != ''cancelled''');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-verifies-identification', '2014-02-20', 'infinity', 'SELECT (CASE 	WHEN app.id is  NULL THEN NULL
		ELSE COUNT(1) > 0
	 END) as vl
...
GROUP BY app.id
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('newtitle-br24-check-rrr-accounted', '2014-02-20', 'infinity', '
...
SELECT CASE WHEN fhCheck IS TRUE THEN (SELECT COUNT(nr) FROM rem_property_rrr) = 0
		ELSE NULL
	END AS vl FROM newFreeholdApp');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-br1-check-required-sources-are-present', '2014-02-20', 'infinity', 'WITH reqForAp AS 	(SELECT DISTINCT ON(r_s.source_type_code) r_s.source_type_code AS typeCode
...
SELECT 	CASE 	WHEN (SELECT (SUM(1) IS NULL) FROM reqForAp) THEN NULL
		...
		ELSE FALSE
	END AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-approve-cancel-old-titles', '2014-02-20', 'infinity', '
WITH 	newFreeholdApp	AS	(SELECT (SUM(1) > 0) AS fhCheck FROM application.service se
				WHERE se.application_id = #{id}
				AND se.request_type_code = ''newFreehold''),
...
SELECT CASE WHEN fhCheck IS TRUE THEN (SELECT COUNT(liveTitle) FROM parent_titles) > 0
	...
	END AS vl FROM newFreeholdApp
');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-br5-check-there-are-front-desk-services', '2014-02-20', 'infinity', 'SELECT CASE WHEN (COUNT(*)= 0) THEN NULL
	ELSE FALSE 
	end AS vl
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-for-new-title-has-cancel-property-service', '2014-02-20', 'infinity', '
WITH 	newFreeholdApp	AS	(SELECT (SUM(1) > 0) AS fhCheck FROM application.service se
				WHERE se.application_id = #{id}
				AND se.request_type_code = ''newFreehold'')
...
SELECT CASE WHEN fhCheck IS TRUE THEN (SELECT COUNT(id) FROM application.service sv 
		...
		ELSE NULL
	END AS vl FROM newFreeholdApp');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('cancel-title-check-rrr-cancelled', '2014-02-20', 'infinity', 'WITH 	pending_property_rrr AS (SELECT DISTINCT ON(rr1.nr) rr1.nr FROM administrative.rrr rr1 
...
SELECT CASE 	WHEN (SELECT (COUNT(*) = 0) FROM cancelPropApp) THEN NULL
		...
		ELSE FALSE
	END AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('app-current-caveat-and-no-remove-or-vary', '2014-02-20', 'infinity', 'SELECT (SELECT (COUNT(*) > 0) FROM application.service sv 
...
ORDER BY 1 desc
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('documents-present', '2014-02-20', 'infinity', 'WITH cadastreDocs AS 	(SELECT DISTINCT ON (id) ss.id, ext_archive_id FROM source.source ss
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-baunit-has-parcels', '2014-02-20', 'infinity', 'select (select count(*)>0 from administrative.ba_unit_contains_spatial_unit ba_su 
...
order by 1
limit 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('current-rrr-for-variation-or-cancellation-check', '2014-02-20', 'infinity', 'SELECT (SUM(1) > 0) AS vl FROM application.service sv 
...
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('power-of-attorney-owner-check', '2014-02-20', 'infinity', 'WITH poaQuery AS (SELECT person_name, py.name AS firstName, py.last_name AS lastName FROM transaction.transaction tn
...
ORDER BY vl
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('service-has-person-verification', '2014-02-20', 'infinity', 'SELECT (CASE 	WHEN sv.application_id is  NULL THEN NULL
		ELSE COUNT(1) > 0
	 END) as vl
FROM application.service sv
...
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('rrr-has-pending', '2014-02-20', 'infinity', 'select count(*) = 0 as vl
...
');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('ba_unit-has-a-valid-primary-right', '2014-02-20', 'infinity', 'SELECT (COUNT(*) = 1) AS vl FROM administrative.rrr rr1 
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-baunit-check-area', '2014-02-20', 'infinity', 'select
       ( 
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('baunit-has-multiple-mortgages', '2014-02-20', 'infinity', 'SELECT	(SELECT (COUNT(*) = 0) FROM application.service sv2
...
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('document-supporting-rrr-is-current', '2014-02-20', 'infinity', 'WITH serviceDocs AS	(SELECT DISTINCT ON (sc.id) sv.id AS sv_id, sc.id AS sc_id, sc.status_code, sc.type_code FROM application.service sv
				INNER JOIN transaction.transaction tn ON (sv.id = tn.from_service_id)
				INNER JOIN administrative.rrr rr ON (tn.id = rr.transaction_id)
				INNER JOIN administrative.source_describes_rrr sr ON (rr.id = sr.rrr_id)
...
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('mortgage-value-check', '2014-02-20', 'infinity', 'SELECT (ap.total_value < rrr.amount) AS vl 
...
order by 1
limit 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('power-of-attorney-service-has-document', '2014-02-20', 'infinity', 'SELECT (SUM(1) = 1) AS vl, get_translation(rt.display_value, #{lng}) as req_type FROM application.service sv
	 INNER JOIN transaction.transaction tn ON (sv.id = tn.from_service_id)
...
ORDER BY 1
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('required-sources-are-present', '2014-02-20', 'infinity', 'WITH reqForSv AS 	(SELECT r_s.source_type_code AS typeCode
			FROM application.request_type_requires_source_type r_s 
				INNER JOIN application.service sv ON((r_s.request_type_code = sv.request_type_code) AND (sv.status_code != ''cancelled''))
			WHERE sv.id = #{id}),
...
ORDER BY vl
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('service-on-complete-without-transaction', '2014-02-20', 'infinity', 'select id in (select from_service_id from transaction.transaction where from_service_id is not null) as vl, 
...
and s.id= #{id}');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('service-title-terminated', '2014-02-20', 'infinity', 'WITH reqForSv AS 	(SELECT sv.id, get_translation(rt.display_value, #{lng}) AS req_type FROM application.service sv 
				INNER JOIN application.request_type rt ON (sv.request_type_code = rt.code)
			WHERE sv.id = #{id} 
...
ORDER BY vl
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('service-check-no-previous-digital-title-service', '2014-02-20', 'infinity', 'SELECT coalesce(not rrr.is_primary, true) as vl
FROM application.service s inner join application.application_property ap on s.application_id = ap.application_id
  INNER JOIN administrative.ba_unit ba ON (ap.name_firstpart, ap.name_lastpart) = (ba.name_firstpart, ba.name_lastpart)
  LEFT JOIN administrative.rrr ON rrr.ba_unit_id = ba.id
WHERE s.id = #{id} 
order by 1 desc
limit 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('target-ba_unit-check-if-pending', '2014-02-20', 'infinity', 'WITH	otherCancel AS	(SELECT (SELECT (COUNT(*) = 0)FROM administrative.ba_unit_target ba_t2 
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('ba_unit-has-cadastre-object', '2014-02-20', 'infinity', 'SELECT count(*)>0 vl
from administrative.ba_unit_contains_spatial_unit ba_s 
WHERE ba_s.ba_unit_id = #{id}');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('ba_unit-has-compatible-cadastre-object', '2014-02-20', 'infinity', 'SELECT  co.type_code = ''parcel'' as vl
...
limit 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('ba_unit-spatial_unit-area-comparison', '2014-02-20', 'infinity', 'SELECT (abs(coalesce(ba_a.size,0.001) - 
...
WHERE ba.id = #{id}
');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('newtitle-br22-check-different-owners', '2014-02-20', 'infinity', 'WITH new_property_owner AS (
...
ORDER BY vl
LIMIT 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('cadastre-redefinition-target-geometries-dont-overlap', '2014-02-20', 'infinity', 'select coalesce(st_area(st_union(co.geom_polygon)) = sum(st_area(co.geom_polygon)), true) as vl
from cadastre.cadastre_object_target co where transaction_id = #{id}');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('area-check-percentage-newareas-oldareas', '2014-02-20', 'infinity', 'select abs((select cast(sum(a.size)as float)
	from cadastre.spatial_value_area a
	where a.type_code = ''officialArea''
        and a.spatial_unit_id in (
	   select co_new.id
   ...
   (select cast(sum(a.size)as float)
	...
	and a.spatial_unit_id in ( 
		...
		from cadastre.cadastre_object_target co_target
		    where co_target.transaction_id = #{id})) 
 < 0.001 as vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('area-check-percentage-newofficialarea-calculatednewarea', '2014-02-20', 'infinity', 'select count(*) = 0 as vl
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('cadastre-object-check-name', '2014-02-20', 'infinity', 'Select cadastre.cadastre_object_name_is_valid(name_firstpart, name_lastpart) as vl 
FROM cadastre.cadastre_object
WHERE transaction_id = #{id} and type_code = ''parcel''
order by 1
limit 1');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('cadastre-redefinition-union-old-new-the-same', '2014-02-20', 'infinity', 'select st_equals(geom_to_snap,target_geom) as vl from cadastre.snap_geometry_to_geometry((select st_union(co.geom_polygon) from cadastre.cadastre_object co 
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('new-cadastre-objects-do-not-overlap', '2014-02-20', 'infinity', 'WITH tolerance AS (SELECT CAST(ABS(LOG((CAST (vl AS NUMERIC)^2))) AS INT) AS area FROM system.setting where name = ''map-tolerance'' LIMIT 1)
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('new-cadastre-objects-present', '2014-02-20', 'infinity', 'select count (*) > 0 as vl from cadastre.cadastre_object where transaction_id= #{id}');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('target-and-new-union-the-same', '2014-02-20', 'infinity', 'select st_equals(geom_to_snap,target_geom) as vl
...
where id in (select cadastre_object_id 
  ...
  system.get_setting(''map-tolerance'')::double precision, true)
 ');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('target-parcels-check-isapolygon', '2014-02-20', 'infinity', 'select St_GeometryType(ST_Union(co.geom_polygon)) = ''ST_Polygon'' as vl
 from cadastre.cadastre_object co 
  inner join cadastre.cadastre_object_target co_target
   on co.id = co_target.cadastre_object_id
    where co_target.transaction_id = #{id}');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('target-parcels-check-nopending', '2014-02-20', 'infinity', 'select (select count(*)=0 
...
where co_target.transaction_id = #{id}
 ');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('target-parcels-present', '2014-02-20', 'infinity', 'select count (*) > 0 as vl from cadastre.cadastre_object_target where transaction_id= #{id}');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('survey-points-present', '2014-02-20', 'infinity', 'select count (*) > 2  as vl from cadastre.survey_point where transaction_id= #{id}');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('ba_unit-has-several-mortgages-with-same-rank', '2014-02-20', 'infinity', 'WITH	simple	AS	(SELECT rr1.id, rr1.nr FROM administrative.rrr rr1
...
SELECT CASE 	WHEN	((SELECT rr5.id FROM administrative.rrr rr5 WHERE rr5.id = #{id} AND rr5.type_code = ''mortgage'') IS NULL) THEN NULL
		...
		ELSE	FALSE
	END AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('rrr-must-have-parties', '2014-02-20', 'infinity', 'select count(*) = 0 as vl
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('rrr-shares-total-check', '2014-02-20', 'infinity', 'SELECT (SUM(nominator::DECIMAL/denominator::DECIMAL)*10000)::INT = 10000  AS vl
FROM   administrative.rrr_share 
WHERE  rrr_id = #{id}
AND    denominator != 0');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('ba_unit-has-caveat', '2014-02-20', 'infinity', 'WITH caveatCheck AS	(SELECT COUNT(*) AS present FROM administrative.rrr rr2 
...
SELECT (SELECT	CASE 	WHEN (SELECT caveat FROM caveatRegn) THEN TRUE
			...
			ELSE TRUE
		END) AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('source-attach-in-transaction-no-pendings', '2014-02-20', 'infinity', 'WITH checkServiceType	AS	(SELECT COUNT(*) AS cnt FROM application.service sv1
...
SELECT	CASE 	WHEN (SELECT (cnt = 0) FROM checkServiceType) THEN NULL
		...
		ELSE FALSE
	END AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('source-attach-in-transaction-allowed-type', '2014-02-20', 'infinity', 'WITH checkServiceType	AS	(SELECT COUNT(*) AS cnt FROM application.service sv1
					INNER JOIN transaction.transaction tn ON (sv1.id = tn.from_service_id)
					INNER JOIN source.source sc1 ON (tn.id = sc1.transaction_id)
				 WHERE tn.id = #{id}
				 AND sv1.request_type_code IN (''regnPowerOfAttorney'', ''regnStandardDocument'')),
...
SELECT	CASE 	WHEN (SELECT (cnt = 0) FROM checkServiceType) THEN NULL
		...
		ELSE FALSE
	END AS vl');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('bulk-spatial-geom-overlaps-with-loading-geom', '2014-02-20', 'infinity', 'select (select count(1)=0
...
');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('bulk-spatial-geom-overlaps-with-existing', '2014-02-20', 'infinity', 'select (select count(1)=0
...
where id = #{id}
  and id in (select transaction_id 
    ...
    where type_code = ''cadastre_object'')
');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('bulk-spatial-geom-not-valid', '2014-02-20', 'infinity', 'select (select count(1)=0
...
where id = #{id}
  and id in (select transaction_id 
    ...
    where type_code = ''cadastre_object'')
');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('bulk-spatial-name-unique', '2014-02-20', 'infinity', 'select (select count(1)=0
  from bulk_operation.spatial_unit_temporary 
...
where id = #{id}
  and id in (select transaction_id 
    ...
    where type_code = ''cadastre_object'')
');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('spatial-unit-group-not-overlap', '2014-02-20', 'infinity', 'select count(*) =0 as vl
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('spatial-unit-group-name-unique', '2014-02-20', 'infinity', 'select count(*)=0 as vl
from (
select count(*)
from cadastre.spatial_unit_group
group by name
having count(*)>1) as tmp');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('public-display-check-baunit-has-co', '2014-02-20', 'infinity', 'SELECT count(bu.id) = 0 as vl
   FROM  application.application_property ap, 
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('public-display-check-complete-status', '2014-02-20', 'infinity', 'select
(select count(*)
from cadastre.cadastre_object co 
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('consolidation-extraction-file-name', '2014-09-12', 'infinity', 'select ''consolidation-'' || system.get_setting(''system-id'') || to_char(clock_timestamp(), ''-yyyy-MM-dd-HH24-MI'') as vl');
...
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('cancel-relation-notification', '2015-02-25', 'infinity', 'UPDATE administrative.notifiable_party_for_baunit 
 set status = ''x''
...
select 0=0 as vl
');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('application-cancel-obscuration-request', '2015-03-02', 'infinity', 'UPDATE party.party
...
select 0=0 as vl
');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('cancel-obscuration-request', '2015-03-02', 'infinity', 'UPDATE party.party
 set classification_code = null,
     redact_code = null
...
select 0=0 as vl
');
INSERT INTO system.br_definition (br_id, active_from, active_until, body) VALUES ('generate-claim-nr', '2014-02-20', 'infinity', 'SELECT coalesce(system.get_setting(''system-id''), '''') || trim(to_char(nextval(''opentenure.claim_nr_seq''), ''0000'')) AS vl');
...
INSERT INTO system.br_validation (id, br_id, target_code, target_application_moment, target_service_moment, target_reg_moment, target_request_type_code, target_rrr_type_code, severity_code, order_of_execution) VALUES ('bf8764ca-99dd-11e3-8284-736cc8ee135c', 'rrr-has-pending', 'rrr', NULL, NULL, 'current', NULL, NULL, 'critical', 290);
...
INSERT INTO system.br_validation (id, br_id, target_code, target_application_moment, target_service_moment, target_reg_moment, target_request_type_code, target_rrr_type_code, severity_code, order_of_execution) VALUES ('bf88c45a-99dd-11e3-8051-13d27ae9940b', 'ba_unit-has-caveat', 'rrr', NULL, NULL, 'current', NULL, NULL, 'critical', 30);
